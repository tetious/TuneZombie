...
describe Track do
  ...
  describe ".file_path" do
    ...
    it "should generate a path with a missing artist" do
      album = FactoryGirl.build(:album, name: 'Tilverton Lives')
      track = FactoryGirl.build(:track, album: album, artist: nil)
